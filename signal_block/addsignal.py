...
class addsignal(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, 22.7273, 1, 0, 0)
        ...
        self.connect((self.blocks_and_const_xx_0, 0), (self.blocks_char_to_float_0, 0))
...
def main(top_block_cls=addsignal, options=None):
