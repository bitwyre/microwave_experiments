...
# Title: Send Data Over USRP
# Author: Muhammad Dzakwan Falih
# Copyright: Bityware
# Description: Trying transmision over radio with text data
...
class Tx_RX_LINK(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Send Data Over USRP")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Send Data Over USRP")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Tx_RX_LINK")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/supernode/Project/microwave_experiments/src/USRP_TX_RX/data.txt', True, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/supernode/Project/microwave_experiments/src/USRP_TX_RX/dta_out.txt', False)
...
def main(top_block_cls=Tx_RX_LINK, options=None):
